...
def localize_instance(
    ...
    if args.file_level:
        ...
        found_files, additional_artifact_loc_file, file_traj = fl.localize(mock=args.mock)
    else:
        ...
        for locs in start_file_locs:
            if locs["instance_id"] == instance_id:
                ...
                if "found_related_locs" in locs:
                    ...
                    if "additional_artifact_loc_related" in locs:
                        additional_artifact_loc_related = locs[
                            "additional_artifact_loc_related"
                        ]
                    if "related_loc_traj" in locs:
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="openai",
        choices=["openai", "deepseek", "anthropic", "Anomy"],
    )
    parser.add_argument(
        "--dataset",
        type=str,
