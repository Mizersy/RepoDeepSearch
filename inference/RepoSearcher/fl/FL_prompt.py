...
Let's locate the faulty file step by step using reasoning, and finally give me the top-5 most likely culprit files for the bug.
You should think step by step before give the final answer. The think process should be enclosed with <think> </think> tag, and the answer should be enclosed with <answer> </answer> tag. Your response should follow the format as follows:
<think>
...
file_guidence_prompt_native_function_call = """
Let's locate the faulty files step by step using reasoning and function calls. 
...
Your goal is to locate the culprit locations for the bug. When you are confident of the answer, you can call the ```exit()``` function to finish the information seeking.
You should only call single function once, finish your response once you take an tool_call action.
You should think step by step and use the function calls to get the information you need. The think process should be enclosed with <think> </think> tag, and the function call should be enclosed with <tool_call> </tool_call> tag. 
"""

file_guidence_prmpt_without_tool_cosil = """
Let's locate the faulty file step by step using reasoning. 
...
location_system_prompt_native_function_call = """You will be presented with a bug report and tools (functions) to access the source code of the system under test (SUT).\nSince the modification is based on the code repository, the modified locations may include files, classes, and functions, and the modifications may be in the form of addition, deletion, or update.\nYour task is to locate the top-5 most likely culprit locations based on the bug report and the information you retrieve using given functions.\n\n\n\n# Tools\n\nYou may call one or more functions to assist with the user query.\n\nYou are provided with function signatures within <tools></tools> XML tags:\n<tools>\n{\"type\": \"function\", \"function\": {\"name\": \"get_code_of_class\", \"description\": \"A tool for geting the class content of specific file\", \"parameters\": {\"type\": \"object\", \"properties\": {\"file_name\": {\"type\": \"string\", \"description\": \"The full file name\", \"enum\": null}, \"class_name\": {\"type\": \"string\", \"description\": \"class name\", \"enum\": null}}, \"required\": [\"file_name\", \"class_name\"]}, \"strict\": true}}\n{\"type\": \"function\", \"function\": {\"name\": \"get_code_of_class_function\", \"description\": \"A tool for geting the function content of specific class\", \"parameters\": {\"type\": \"object\", \"properties\": {\"file_name\": {\"type\": \"string\", \"description\": \"The full file name\", \"enum\": null}, \"class_name\": {\"type\": \"string\", \"description\": \"class name\", \"enum\": null}, \"func_name\": {\"type\": \"string\", \"description\": \"function name\", \"enum\": null}}, \"required\": [\"file_name\", \"class_name\", \"func_name\"]}, \"strict\": true}}\n{\"type\": \"function\", \"function\": {\"name\": \"get_code_of_file_function\", \"description\": \"A tool for geting the function content of specific file\", \"parameters\": {\"type\": \"object\", \"properties\": {\"file_name\": {\"type\": \"string\", \"description\": \"The full file name\", \"enum\": null}, \"func_name\": {\"type\": \"string\", \"description\": \"function name\", \"enum\": null}}, \"required\": [\"file_name\", \"func_name\"]}, \"strict\": true}}\n{'type': 'function', 'function': {'name': 'exit', 'description': 'exit if you have found all the information needed.', 'parameters': {}}}\n</tools>\n\nFor each function call, return a json object with function name and arguments within <tool_call></tool_call> XML tags:\n<tool_call>\n{\"name\": <function-name>, \"arguments\": <args-json-object>}\n</tool_call>
Note: all the arguments must be filled in.
"""
...
location_guidence_prmpt_cot_and_func_call = """
Let's locate the faulty functions step by step using reasoning and function calls. 
I have pre-identified top-5 files that may contain bugs. There stuctures are as follows:
{bug_file_list}
The formal parameter 'file_name' takes the value in "file:"
The formal parameter 'ckass_name' takes the value in "class:"
...
For static functions, you can use 'get_code_of_file_function', and for class functions, you can use 'get_code_of_class_function'. 
Your goal is to locate the culprit locations for the bug. When you are confident of the answer, you can call the ```exit()``` function to finish the information seeking.
You should only call single function once, finish your response once you take an action.
You should think step by step and use the function calls to get the information you need. The think process should be enclosed with <think> </think> tag, and the function call should be enclosed with <action> </action> tag. Your response should follow the format as follows:
<think>
Your reasoning process
</think>
<action>
...
location_guidence_prompt_native_function_call = """
Let's locate the faulty functions step by step using reasoning and function calls. 
I have pre-identified top-5 files that may contain bugs. There stuctures are as follows:
{bug_file_list}
The formal parameter 'file_name' takes the value in "file:"
...
Based on the available information, locate the faulty file step by step using reasoning, and finally give me the top-5 most likely culprit files for the bug.
You should think step by step before give the final answer. The think process should be enclosed with <think> </think> tag, and the answer should be enclosed with <answer> </answer> tag. Your response should follow the format as follows:
<think>
Your reasoning process
</think>
...
file_reflection_prompt_native_function_call = """
Please look through the following GitHub problem description and Repository structure and provide a list of files that one would need to edit to fix the problem.
I have already find 5 relevent files. Accrording to the import relations, construct the call graph first.
Then, Rank them again and reflect the result.
...
Use the available tools to gather the necessary information. Once you have collected all the required details, call the exit tool to conclude the information-seeking process.
"""
