...
class GetCodeOfClassFunctionTool(BaseTool):
    ...
    def __init__(self, config: dict, tool_schema: OpenAIFunctionToolSchema):
        ...
        _tool_schema = OpenAIFunctionToolSchema.model_validate({
            ...
            "function": {
                ...
                "description": "Get the code of a specified function in the given class, file, and python project.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "file_name": {
...
Here is a result of function call get_code_of_class_function({file_name}, {class_name}, {func_name}).
<code>
{search_result}
</code>
