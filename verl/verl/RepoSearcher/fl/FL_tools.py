...
def load_repo_structure(instance_id: str, repo: str, base_commit: str):
    PROJECT_FILE_LOC = ""
...
def get_code_of_class(file_name: str, class_name: str, instance_id: str, repo: str, base_commit: str):
    d = load_repo_structure(instance_id, repo, base_commit)
    structure = d["structure"]
    files, classes, functions = extract_structure(structure)
...
def get_code_of_class_function(file_name: str, class_name: str, func_name: str, instance_id: str, repo: str, base_commit: str):
    d = load_repo_structure(instance_id, repo, base_commit)
    structure = d["structure"]
    files, classes, functions = extract_structure(structure)
...
def get_code_of_file_function(file_name: str, func_name: str, instance_id: str, repo: str, base_commit: str):
    d = load_repo_structure(instance_id, repo, base_commit)
    structure = d["structure"]
    files, classes, functions = extract_structure(structure)
...
if __name__ == '__main__':
    ...
    print(get_code_of_class('sympy/matrices/expressions/blockmatrix.py', 'BlockMatrix', 'Significant-Gravitas__AutoGPT-8930', "Significant-Gravitas/AutoGPT", "d7d69f397f544764ac3924b6362f27cff78ca259"))
