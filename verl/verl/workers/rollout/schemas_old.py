...
class AsyncRolloutRequest(BaseModel):
    ...
    def get_generation_prompt(self, tokenizer: PreTrainedTokenizer) -> list[int]:
        return tokenizer.apply_chat_template(  # type: ignore
            ...
            # tools=[tool.model_dump() for tool in self.tools] if self.tools else None, # hack here, remove tool description in apply_chat_template
